...
public class Tab6Controller {
	...
	private static final String PATH2 = System.getProperty("user.dir") + "/endedforgood.json";
	private static final String PATH = "endedforgood.json";
	...
	@FXML private Button save, add, delete, ongoing, fellBehind, toBeStarted, seasonEnded;
