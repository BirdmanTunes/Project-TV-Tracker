...
public class Tab2Controller {
	...
	private static final String PATH2 = System.getProperty("user.dir") + "/ongoing.json";
	private static final String PATH = "ongoing.json";
	...
	@FXML private Button save, add, delete, fellBehind, toBeStarted, seasonEnded, endedForGood;
	@FXML private Label message;
	@FXML private TextField nameField, seasonField, episodeField, dateField, commentField;
	@FXML private HBox upper, lower;
	...
	public void initialize() throws IOException {
		...
		table.setItems(list);
		checkIfTextThere();
//		table.getStylesheets().add("/application/view/Tab2Style.css");
//		upper.setStyle("-fx-background-color: #2C2C2C;");
//		lower.setStyle("-fx-background-color: #2C2C2C;");
